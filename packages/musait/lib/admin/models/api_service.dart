...
class ApiService {
  ...
  Future<GalleryAlbum> fetchAlbum(int id) async {
    return GalleryAlbum.fromJson(asJsonMap(await _get(_uri('/api/gallery/albums/$id'))));
  }

  Future<GalleryAlbum> createAlbum({required String title, required List<String> photoPaths}) async {
    final request = http.MultipartRequest('POST', _uri('/api/gallery/albums'))
  ...
  Future<void> deleteAlbum(int id) async {
    final response = await _client
        .delete(_uri('/api/gallery/albums/$id'), headers: _headers)
