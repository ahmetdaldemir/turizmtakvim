...
class AppConfig {
  ...
  static const sector = String.fromEnvironment('SECTOR', defaultValue: 'villa');
  static const productionUrl = 'https://musaitvillam.com';

  static bool get isKuafor => sector == 'kuafor';
  static String get appTitle => isKuafor ? 'Kuaför Randevu' : 'Villa Rezervasyon';
  ...
  static String get demoEmail => isKuafor ? 'musteri@takvim.app' : 'villa.musteri@takvim.app';

  static String get baseUrl {
    if (_defined.isNotEmpty) return _defined;
    if (kReleaseMode) return productionUrl;
    if (lanIp.isNotEmpty) return 'http://$lanIp:3000';
