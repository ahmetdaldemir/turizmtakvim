    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            icon: Icon(widget.session.vertical?.key == 'kuafor' ? Icons.content_cut : Icons.home_outlined),
            selectedIcon: Icon(widget.session.vertical?.key == 'kuafor' ? Icons.content_cut : Icons.home),
            label: resourceLabel,
          ),
